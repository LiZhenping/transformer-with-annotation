...
# TODO 常改动参数
parser.add_argument('--type', default='evaluate') # 默认是训练模式, 若传递 "evaluate" 则对 dev数据集进行预测输出
...
parser.add_argument('--max-length', default=75, type=int)
parser.add_argument('--save-file', default='save/model1.pt') # 模型保存位置
